function ex11() {
  ...
  let quantiaCarro = parseFloat(
    prompt("Digite o valor recebido por cada carro vendido: ")
  );

  let totalPagamento =
    salarioFixo + totalVendas * 0.05 + nCarros * quantiaCarro;
...
function ex17() {
  alert(
    "Ler as notas da 1a. e 2a. avaliações de um aluno. Calcular a média aritmética simples e escrever uma mensagem que diga se o aluno foi ou não aprovado (considerar que nota igual ou maior que 6 oaluno é aprovado). Escrever também a média calculada."
  );
...
function ex22() {
  ...
  let horasTrabalhadas = parseInt(
    prompt("Digite a quantidade horas que você trabalhou: ")
  );
...
function ex32() {
  ...
  let golsTime1 = parseFloat(
    prompt("Digite a quantidade de gols marcados pelo time " + time1)
  );
  let time2 = prompt("Digite o nome do segundo time: ");
  let golsTime2 = parseFloat(
    prompt("Digite a quantidade de gols marcados pelo time " + time2)
  );
...
function ex35() {
  ...
  let litros = parseInt(
    prompt("Digite a quantidade de combustivel em litros: ")
  );
...
function ex36() {
  ...
  alert(
    "A soma do mais velho com a mais nova é de: " +
      (velho + nova) +
      "\nO produto da mais velha com o mais novo é de: " +
      velha * novo
  );
}
...
function ex37() {
  ...
  let kgMorango = parseInt(
    prompt("Digite a quantidade de morangos que você deseja comprar: (KG)")
  );
  let kgMaca = parseInt(
    prompt("Digite a quantidade de maçãs que você deseja comprar: (KG)")
  );
